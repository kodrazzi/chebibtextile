    ...
    <div class="row">
      <div class="col-sm-12 col-xs-12">
        <div class="box box-solid">
          <form role="form" action="hakkimizda-guncelle.php" method="post" enctype="multipart/form-data">
            <!-- Box Header -->
            <!-- ================================================== -->
                  ...
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div class="input-group">
                      <div class="input-group-addon btn btn-default btn-file">
                        ...
                        <input type="file" name="hakkimzidaResim">
                      </div>
                ...
                <div class="col-sm-9 col-xs-12">
                  <div class="form-group">
                    <label>Bölüm ile ilgili içerik ekleyin.</label>
                      <textarea id="editor5" name="editor" rows="15" cols="75"><?php echo $icerik; ?></textarea>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-xs-12">
                <p class="box-title">Hakkımızda</p>
              </div>
