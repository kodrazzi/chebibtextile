  ...
  <section class="content">
    <div class="row">
      <div class="col-sm-12 col-xs-12">
        <form role="form" action="misyonumuz-guncelle.php" method="post" enctype="multipart/form-data">
          <div class="box box-solid">
            <!-- Box Header -->
            <!-- ================================================== -->
            <div class="box-header with-border">
              <div class="col-sm-6 col-xs-12">
                <h3 class="box-title">Misyonumuz</h3>
              </div>
                  ...
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div class="input-group">
                      <div class="input-group-addon btn btn-default btn-file">
                        ...
                        <input type="file" name="resimLink">
                      </div>
                ...
                <div class="col-sm-9 col-xs-12">
                  <div class="form-group">
                    <label>Bölüm ile ilgili içerik ekleyin.</label>
                      <textarea id="editor7" name="editor" rows="15" cols="75"><?php echo $icerik; ?></textarea>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-xs-12">
                <p class="box-title">Misyonumuz</p>
              </div>
