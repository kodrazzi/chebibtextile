        ...
        <div class="ct_carousel__hero--item">
          <div class="ct_carousel__hero--item__content">
            <?php
              if($_GET['lang'] == "tr"){
              ?>
                <h2><?php echo $sliders['slogan_1_tr']; ?></h2>
                <p><?php echo $sliders['slogan_2_tr']; ?></p>
              <?php
              }else {
              ?>
                <h2><?php echo $sliders['slogan_1_en']; ?></h2>
                <p><?php echo $sliders['slogan_2_en']; ?></p>
              <?php
              }
            ?>
          </div>
          <img class="ct_carousel__hero--item__media" src="./assets/img/slides/<?php echo $sliders['slider_photo_name']; ?>" alt="item">
        </div>
        <?php 
        }
      }?>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="ct_clients">
            <?php
            $sorgu = $db->query("SELECT * FROM referance",PDO::FETCH_ASSOC) or die (mysql_error());
            if ( $sorgu->rowCount() ){
              foreach ($sorgu as $referance)
              {
              ?>
              <a href="<?php echo $referance['href']; ?>" class="ct_clients__media" target="_blank">
                <img src="./assets/img/clients/<?php echo $referance['photo_name']; ?>" alt="<?php echo $referance['firma']; ?>">
              </a>
              <?php 
              }
            }?>
